				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 for(int count=0; count<=trials; count++){
				...
				double BasicFlesch = BasicDoc.getFleschScore();
			 }
			 ...
			 for(int count=0; count<=trials; count++){
				 EfficientDocument EffiDoc = new EfficientDocument(s);
				 double EffiFlesch = EffiDoc.getFleschScore();
			 }
			 double EndTime1 = System.nanoTime();
			 double TimeElapsed1 = (EndTime1-StartTime1)/1000000000.0;
